                                ...
                                <?php echo form_open_multipart("");?>
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input id="title" type="text" class="form-control" name="title" placeholder="Masukan Judul">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="rpp_index" type="text" class="form-control" name="rpp_index" placeholder="Masukkan RPP Index">
                                            <span class='text-danger'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="ckeditor" class="form-control" name="teori" placeholder="Masukkan Teori Materi"><?php echo set_value('teori'); ?></textarea>
                                            <span class='text-danger'>
