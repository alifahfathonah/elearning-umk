  ...
  <div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
      ...
      <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
            <h5 class="card-header">Tabel Kuis
...
<div class="modal modal-primary fade" id="modal-add">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="" action="<?php echo base_url() . 'dashboard/kuis/createData'; ?>" method="post">
...
<div class="modal modal-primary fade" id="modal-edit">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="" action="<?php echo base_url() . 'dashboard/kuis/editData'; ?>" method="post">
        <div class="modal-body">
